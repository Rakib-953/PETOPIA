        ...
        <div class="row">
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky">
                    ...
                    <div class="logo">
                        <a href="index.php">
                            <img src="images/PETOPIA_logo.png" alt="PETOPIA Logo">
                        </a>
                    </div>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="inventory_management.php">Inventory</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="stats-section mt-4">
                            <div class="card stat-card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" id="total-appointments">Loading...</p>
                                </div>
                            </div>
                            <div class="card stat-card">
                                <div class="card-body">
                            ...
                            <div class="card stat-card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text" id="pending-reviews">Loading...</p>
                                </div>
                            </div>
                        </div>
                    </div>
